...
export const saintsApologeticTopics: ApologeticTopicPageData[] = [
  ...
  },
  {
    ...
    icon: BookOpen,
    parent: { label: parentLabel, href: parentHref },
    nav: [{ id: "ejemplos", label: "Ejemplos y referencias" }],
    rightNav: [{ label: "Ejemplos y referencias", href: "#ejemplos" }],
    relatedResources: sharedRelated,
    sections: [
      {
        id: "ejemplos",
        title: "Ejemplos y referencias",
        html: htmlBySlug.get("ejemplo-de-culto-a-los-santos") ?? "",
      },
    ],
  },
  {
    slug: "argumentos-de-la-iglesia-catolica-para-permitir-el-culto-a-los-santos",
    title: "Documentos y argumentos de la Iglesia Católica",
