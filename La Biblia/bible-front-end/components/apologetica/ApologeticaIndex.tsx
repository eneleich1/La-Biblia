...
function ResourceCard({ resource }: { resource: ApologeticaResource }) {
  ...
  return (
    <article className="flex h-full flex-col rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-card)]">
      ...
      <span className="mt-4 inline-flex w-fit items-center justify-center gap-1.5 rounded-md border border-[var(--border)] bg-[var(--background-soft)] px-3 py-1.5 text-xs font-medium text-[var(--text-muted)]">
